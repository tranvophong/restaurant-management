...
namespace ServeSys.API.Modules.Table.Interfaces.Repositories
{
    ...
    {
        Task<IEnumerable<DiningTable>> FindAllAsync(Expression<Func<DiningTable, bool>>? predicate = null, 
            CancellationToken cancellationToken = default);
        Task<DiningTable?> FindAsync(Expression<Func<DiningTable, bool>>? predicate,
          CancellationToken cancellationToken = default);
